...
/*
This class is responsible for Spawning Powerups, Enemy and Boss game entities
*/
public class SpawnManager : MonoBehaviour
{
    ...
    // Accesses Player, UIManager, Background classes
    void Start()
    {
        ...
        _backgroundArteryB1OnOFF = GameObject
            .Find("Artery_B1")
    ...
    // Instantiates Enemy 003 and Boss
    void Update()
    {
    ...
    // spawn an enemy game object every 5 sec
    IEnumerator SpawnEnemyRoutine()
    {
        while (stopSpawning == false)
        {
            ...
            {
                GameObject newErythrocyte = Instantiate(
                    Erythrocytes,
                    posToSpawn,
                    Quaternion.identity
                );
    ...
    // Instantiate's Enenmy 003 game entity
    IEnumerator SpawnEnemy003Routine()
    {
        while (stopSpawning == false && enemy003Counter < 3)
        {
            if (enemy003Counter < 3)
            {
                ...
                GameObject newEnemy003 = Instantiate(
                    enemyPrefab003,
                    posToSpawn,
                    Quaternion.identity
                );
    ...
    // Instantiate's Enenmy 004 game entity
    IEnumerator SpawnEnemy004Routine()
    {
        ...
        while (stopSpawning == false)
        {
            ...
            GameObject newEnemy004 = Instantiate(
                enemyPrefab004,
                posToSpawn004,
                Quaternion.identity
            );
    ...
    // Instantiate's Enenmy 005 game entity
    IEnumerator SpawnEnemy005Routine()
    {
        ...
        if (enemy005Counter < enemy005SpawnAmount)
        {
            ...
            while (stopSpawning == true && enemy005Counter < enemy005SpawnAmount)
            {
                ...
                GameObject newEnemy005 = Instantiate(
                    enemyPrefab005,
                    posToSpawn2,
                    Quaternion.identity
                );
    ...
    // Instantiate's randomly one of the three powerups
