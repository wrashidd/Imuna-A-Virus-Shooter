...
/*
Main Player class that handles the player's game logic
*/
public class Player : MonoBehaviour
{
    ...
    // Accesses SpawnManager, UIManager, Background, Background_B1 classes
    void Start()
    {
        playerStart();
    ...
    // Calculates player's movement on user's keyboard inputs
    // Portals/Connects left and right screen side borders
    ...
    // Instantiates and Handles Triple Shot bullet logic
    void FireTripleShot()
    {
        _laserShotOnOFF = false;
    ...
    // Instantiates and Handles Super Shot bullet logic
    void FireSuperShot()
    {
        _laserShotOnOFF = false;
        _canFire = Time.time + _fireRate;
    ...
    // Instantiates and Handles Laser Shot bullet logic
    void FireLaser()
    {
        _canFire = Time.time + _fireRate;
    ...
    // Launches playerStart Coroutine
    public void playerStart()
    {
        StartCoroutine(playerStartRoutine());
    }

    // Defines player's activity on game start
    ...
    // Reward system that add points to the player
    ...
    // Demage system that removes points and lives from the player
    // Animates damage
    public void Damage()
    {
    ...
    // Counts player's scores and life count
    // Updates UI related to Scores, Life
    ...
    // Defines Bullet's super speed and colors
    ...
    // Defines Bullet's normal speed and colors
    ...
    // Activates Player's protective shield
    ...
    // Defines Player's protective shield coroutine
    ...
    // Changes player's color on damage
